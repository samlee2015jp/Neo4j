...
if __name__ == "__main__":
    ...
    # the sentence
    sentence = "Liu, Li and other people go to aist in Tokyo Japan every weekday, and we come from different countries and areas. aist is one of departments in National Institute of Advanced Industrial Science amd Technology which is a ognazation like WTO."
